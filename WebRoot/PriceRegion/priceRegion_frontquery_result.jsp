		...
		<div class="col-md-12 wow fadeInDown" data-wow-duration="0.5s">
			<div>
				...
				<ul class="nav nav-tabs" role="tablist">
			    	...
			    	<li role="presentation" class="active"><a href="#priceRegionListPanel" aria-controls="priceRegionListPanel" role="tab" data-toggle="tab">价格区间列表</a></li>
			    	<li role="presentation" ><a href="<%=basePath %>PriceRegion/priceRegion_frontAdd.jsp" style="display:none;">添加价格区间</a></li>
				</ul>
			  	<!-- Tab panes -->
				    				...
				    				<table class="table table-condensed table-hover">
				    					...
				    					<% 
				    	            		...
				    	            		for(int i=0;i<priceRegionList.size();i++) {
					    	            		...
					    	            		PriceRegion priceRegion = priceRegionList.get(i); //获取到价格区间对象
 										%>
 										<tr>
 											<td><%=currentIndex %></td>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><i class="fa fa-edit"></i>&nbsp;价格区间信息编辑</h4>
      </div>
