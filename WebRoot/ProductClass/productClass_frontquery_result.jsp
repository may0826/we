				    			...
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					...
				    					<% 
 										...
 										<tr>
 											<td><%=currentIndex %></td>
 											<td><%=productClass.getProductClassId() %></td>
 											<td><%=productClass.getProductClassName() %></td>
 											<td>
 												<a href="<%=basePath  %>ProductClass/<%=productClass.getProductClassId() %>/frontshow"><i class="fa fa-info"></i>&nbsp;查看</a>&nbsp;
 												<a href="#" onclick="productClassEdit('<%=productClass.getProductClassId() %>');" style="display:none;"><i class="fa fa-pencil fa-fw"></i>编辑</a>&nbsp;
 												<a href="#" onclick="productClassDelete('<%=productClass.getProductClassId() %>');" style="display:none;"><i class="fa fa-trash-o fa-fw"></i>删除</a>
 											</td> 
 										</tr>
 										<%}%>
				    				</table>
