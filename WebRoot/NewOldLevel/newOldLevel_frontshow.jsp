...
<div class="container">
	<ul class="breadcrumb">
  		...
  		<li><a href="<%=basePath %>NewOldLevel/frontlist">新旧程度信息</a></li>
  		<li class="active">详情查看</li>
	</ul>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">记录编号:</div>
		<div class="col-md-10 col-xs-6"><%=newOldLevel.getLevelId()%></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">新旧程度:</div>
		<div class="col-md-10 col-xs-6"><%=newOldLevel.getLevelName()%></div>
	</div>
	<div class="row bottom15">
