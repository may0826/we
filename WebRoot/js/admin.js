		       ...
		       text: "商品信息管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "ProductInfo/productInfo_add.jsp"
			    	   	},
			    		{
			    	   		text: "商品信息管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "ProductInfo/productInfo_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "留言管理",
		       ...
		       text: "公告信息管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "Announce/announce_add.jsp"
			    	   	},
			    		{
			    	   		text: "公告信息管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "Announce/announce_query_result.jsp"
			    	    }
			    	   ]
			}, {
			       text: "参数设置管理",
				       ...
				       children:
				    	   [{
				    		    ...
				    		    state: "open",
				    		    iconCls: "icon-add-new",
				    		    url: "PriceRegion/priceRegion_add.jsp"
				    	   	},
				    		{
				    	   		text: "价格区间管理",
				    	   		state: "open",
				    	   		iconCls: "icon-manager",
				    	   		url: "PriceRegion/priceRegion_query_result.jsp"
				    	    },
				    	    {
				    		    text: "添加新旧程度",
				    		    state: "open",
				    		    iconCls: "icon-add-new",
				    		    url: "NewOldLevel/newOldLevel_add.jsp"
				    	   	},
				    		{
				    	   		text: "新旧程度管理",
				    	   		state: "open",
				    	   		iconCls: "icon-manager",
				    	   		url: "NewOldLevel/newOldLevel_query_result.jsp"
				    	    },
				    	    {
				    		    text: "添加区域信息",
				    		    state: "open",
				    		    iconCls: "icon-add-new",
				    		    url: "AreaInfo/areaInfo_add.jsp"
				    	   	},
				    		{
				    	   		text: "区域信息管理",
				    	   		state: "open",
				    	   		iconCls: "icon-manager",
				    	   		url: "AreaInfo/areaInfo_query_result.jsp"
				    	    }
