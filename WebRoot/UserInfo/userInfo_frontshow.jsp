...
<div class="container">
	<ul class="breadcrumb">
  		...
  		<li><a href="<%=basePath %>UserInfo/frontlist">用户信息信息</a></li>
  		<li class="active">详情查看</li>
	</ul>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">手机用户名:</div>
		<div class="col-md-10 col-xs-6"><%=userInfo.getUser_name()%></div>
	</div>
	 
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">姓名:</div>
		<div class="col-md-10 col-xs-6"><%=userInfo.getRealname()%></div>
	</div>
	<div class="row bottom15"> 
	...
	<div class="row bottom15"> 
		...
		<div class="col-md-10 col-xs-6"><%=userInfo.getBornDate()%></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">用户qq:</div>
		<div class="col-md-10 col-xs-6"><%=userInfo.getQq()%></div>
	</div>
	<div class="row bottom15"> 
	...
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">用户邮箱:</div>
		<div class="col-md-10 col-xs-6"><%=userInfo.getEmail()%></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">用户头像:</div>
		<div class="col-md-10 col-xs-6"><img class="img-responsive" src="<%=basePath %><%=userInfo.getMyPhoto() %>"  border="0px"/></div>
	</div>
	<div class="row bottom15"> 
