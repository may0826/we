...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.jsp" class="navbar-brand">二手平台网</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li><a href="<%=basePath %>ProductInfo/frontlist">商品信息</a></li>
                <li><a href="<%=basePath %>PriceRegion/frontlist">价格区间</a></li>
                <li><a href="<%=basePath %>NewOldLevel/frontlist">新旧程度</a></li>
                <li><a href="<%=basePath %>AreaInfo/frontlist">区域信息</a></li>
                <li><a href="<%=basePath %>Announce/frontlist">公告信息</a></li>
