...
public class ApiLeavewordController {
	...
	public JsonResult userList(String leaveTitle,@ModelAttribute("userObj") UserInfo userObj,String leaveTime,Integer page,Integer rows, Model model, HttpServletRequest request,HttpServletResponse response) throws Exception {
		if (page==null || page == 0) page = 1;
		if (leaveTitle == null) leaveTitle = "";
		if (leaveTime == null) leaveTime = "";
		//通过accessToken获取到用户信息 
