...
public class ProductClassController extends BaseController {
	...
	public String frontlist(Integer currentPage, Model model, HttpServletRequest request) throws Exception  {
     ...
     /*前台查询ProductClass信息*/
	@RequestMapping(value="/{productClassId}/frontshow",method=RequestMethod.GET)
	public String frontshow(@PathVariable Integer productClassId,Model model,HttpServletRequest request) throws Exception {
		/*根据主键productClassId获取ProductClass对象*/
        ProductClass productClass = productClassService.getProductClass(productClassId);
	...
	@RequestMapping(value="/{productClassId}/update",method=RequestMethod.GET)
	public void update(@PathVariable Integer productClassId,Model model,HttpServletRequest request,HttpServletResponse response) throws Exception {
        /*根据主键productClassId获取ProductClass对象*/
        ProductClass productClass = productClassService.getProductClass(productClassId);
	...
	/*ajax方式更新商品分类信息*/
	@RequestMapping(value = "/{productClassId}/update", method = RequestMethod.POST)
    ...
    /*删除商品分类信息*/
	@RequestMapping(value="/{productClassId}/delete",method=RequestMethod.GET)
	public String delete(@PathVariable Integer productClassId,HttpServletRequest request) throws UnsupportedEncodingException {
		  try {
	...
	public void delete(String productClassIds,HttpServletRequest request,HttpServletResponse response) throws IOException, JSONException {
		String message = "";
    	boolean success = false;
        try { 
        	int count = productClassService.deleteProductClasss(productClassIds);
        	success = true;
