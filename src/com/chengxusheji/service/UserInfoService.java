...
public class UserInfoService {
    ...
    /*按照查询条件分页查询用户信息记录*/
    public ArrayList<UserInfo> queryUserInfo(String user_name,String realname,String bornDate,int currentPage) throws Exception { 
    	...
    	if(!bornDate.equals("")) where = where + " and t_userInfo.bornDate like '%" + bornDate + "%'";
    	int startIndex = (currentPage-1) * this.rows;
    	return userInfoMapper.queryUserInfo(where, startIndex, this.rows);
    }

    /*按照查询条件查询所有记录*/
    public ArrayList<UserInfo> queryUserInfo(String user_name,String realname,String bornDate) throws Exception  { 
     	String where = "where 1=1";
    	if(!user_name.equals("")) where = where + " and t_userInfo.user_name like '%" + user_name + "%'";
    	if(!realname.equals("")) where = where + " and t_userInfo.realname like '%" + realname + "%'";
    	if(!bornDate.equals("")) where = where + " and t_userInfo.bornDate like '%" + bornDate + "%'";
    ...
    /*当前查询条件下计算总的页数和记录数*/
    public void queryTotalPageAndRecordNumber(String user_name,String realname,String bornDate) throws Exception {
     	String where = "where 1=1";
    	if(!user_name.equals("")) where = where + " and t_userInfo.user_name like '%" + user_name + "%'";
    	if(!realname.equals("")) where = where + " and t_userInfo.realname like '%" + realname + "%'";
    	if(!bornDate.equals("")) where = where + " and t_userInfo.bornDate like '%" + bornDate + "%'";
    ...
    /*关联读者微信openid记录*/
    public void updateUserInfoOpenid(String user_name,String openId) throws Exception {
        userInfoMapper.updateUserInfoOpenid(user_name, openId);
    }
